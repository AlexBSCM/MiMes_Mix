package com.mimes.app.data.repository

import android.content.Context
import androidx.datastore.preferences.core.booleanPreferencesKey
import androidx.datastore.preferences.core.edit
import androidx.datastore.preferences.preferencesDataStore
import com.mimes.app.data.model.User
import com.mimes.app.domain.repository.AuthRepository
...
class AuthRepositoryImpl @Inject constructor(
    ...
    override fun signInAnonymously(nickname: String): Flow<Result<String>> = flow {
        ...
        firestore.collection("users").document(user.uid).set(mimesUser).await()
